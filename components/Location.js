  ...
  useEffect(() => {
          ...
          const fetchWeatherData = async () => {
              try {
                  ...
                  console.log(`Fetching weather data for ${locationData.city} at coordinates: ${latitude}, ${longitude}`);
  ...
  return (
    <div className = "card">
        ...
        <div className="card-body">
            ...
            <h5 className="card-text">{locationData.latitude},{locationData.longitude}</h5>
        </div>
    </div>
  );
};
